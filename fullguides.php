								...
								<tr>
									<td class="body_container">
										<?php
											echo'
											<div class="head_nav">
												<a href="guides.php" class="head_nav_news">Guides</a> > 
												<a href="fullguides.php?id='.$row['id'].'" class="head_nav_current">'.$row['tittle'].'</a>
											</div>
										...
										<div>
											...
											<div class="comments">
												<?php
												  $page_id = $row['id'];
													$sql_comment = "SELECT * FROM comment_guides WHERE page_id='$page_id'"; 
											...
											<div class="create_comment">
												...
												<form name="comment" action="comment_guides.php" method="POST">
