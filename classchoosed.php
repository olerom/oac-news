						...
						<tbody background="img/container_bg.jpg">
							...
							<tr>
								<td class="body_container">
									...
									echo'
										<div class="head_nav">
											<a href="classes.php" class="head_nav_news">Classes</a> > 
											<a href="classchoosed.php?id='.$row['id'].'" class="head_nav_current">'.ucfirst($row['classname']).'</a>
										</div>
										...
										<tbody>
											<tr>
												...
												<td>
													<table width="335px" height="735px" style="background:url(img/classes/'.$row['classname'].'_class.jpg); background-repeat: no-repeat; background-position: center center;">
														<tbody>
															<tr>	
																<td width="276px" height="720px" class="class_border">
																</td>
															</tr>
														</tbody>
													</table>
